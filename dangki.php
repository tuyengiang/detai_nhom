...
<?php
        if($_SERVER["REQUEST_METHOD"]=="POST"){
                            ...
                            $nam=$_POST["nam"];
                            $femal=$_POST["femal"];
                            $sql="INSERT INTO user (user,hoten,password,ngay,thang,nam,femal)
                                        VALUES('{$user}','{$hoten}','{$password}','{$ngay}','{$thang}','{$nam}','{$femal}')
                            ";
...
<html>
<head>
	<title>SysDney - Đăng Kí Thành Viên</title>
	<meta charset="utf-8">
	...
	<div id="main">
                    <div id="main-left">
                            ...
                            <form method="post">
                                    ...
                                    <label><h4><i class="fa fa-code"></i> Xác Nhận Password</h4>
                                            <input type="password" name="password" placeholder="Xác nhận lại password">
                                    </label>
                                    ...
                                    <center>
                                                <button type="submit"><i class="fa fa-plus"></i> Đăng Ký</button>
                                    </center>
                            </form>
                    </div><!--main-left-->
                    <div id="main-right">
