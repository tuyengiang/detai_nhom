...
<body>
	...
	<div id="main">
		<div id="main-left">
			<div id="title"><i class="fa fa-user"></i> Thông Tin Về Bạn</div>
			<div id="main-thongtin">
				...
				<div class="main-thongtin-right">
					...
					?>
					<label><font color="#0098DB"><i class="fa fa-user"></i> Họ Tên: </font> <?php echo $row['hoten'];?></label><br>
					<label><font color="#0098DB"><i class="fa fa-calendar"></i> Ngày Sinh: </font> <?php echo $row['ngay'];?> / <?php echo $row['thang'];?> / <?php echo $row['nam'];?></label><br>
					<label><font color="#0098DB"><i class="fa fa-venus-mars"></i> Giới Tính: </font> 
							<?php
								if($row["femal"]==1){
									echo "Nam";
								}else{
					...
					<label><font color="#0098DB"><i class="fa fa-flash"></i> Chức Vụ: </font> <a href="#"><b>Thành Viên</b></a></label><br>
					<label>
						<a href="edit-login.php"><button type="submit"><i class="fa fa-edit"></i> Cập Nhật</button></a>
					</label>
		...
		<div id="main-right">
			<div id="title"><i class="fa fa-clone"></i> Chức Năng Của Bạn</div>
			<ul>
				<li><a href="create-posts.php"><i class="fa fa-plus-circle"></i> Thêm Bài Viết</li>
				<li><a href="list-posts.php"><i class="fa fa-bars"></i> Bài Viết Của Bạn</li>
				<li><a href="edit-login.php"><i class="fa fa-sign-in"></i> Sửa Thông Tin Của Bạn</li>
			</ul>
