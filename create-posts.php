...
<?php
	...
	if($_SERVER["REQUEST_METHOD"]=="POST"){
		...
		$sql="INSERT INTO posts (title,excerpt,content,cat_id,user_id)
			VALUES('{$title}','{$excerpt}','{$content}',1,1)
		";
...
<html>
<head>
	<title>Tạo Bài Viết - Sysdney</title>
	<meta charset="utf-8"/>
	<!--meta seo-->
...
<body>
	...
	<div id="main">
		<div id="main-left">
			<div id="title"><i class="fa fa-edit"> Viết Bài Viết Mới</i></div>
			...
			<form method="post" action="">
				...
				<label><h4>Nội Dung Bài Viết</h4>
					<textarea placeholder="Nhập nội dung bài viết" name="content"></textarea>
				</label>
				<br>
				<center><button type="submit">Viết Bài</button>
				</center>
			</form>
